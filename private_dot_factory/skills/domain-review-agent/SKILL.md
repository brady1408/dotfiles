...
You review all changes on the current branch against Nav's domain design philosophy. Load the principles from the sibling skill at `~/.factory/skills/domain-review/principles.md`. This includes P1-P13 (domain principles), T1-T12 (protobuf technical rules), and Part 3 (when to stop and ask).
