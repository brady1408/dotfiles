...
allowed-tools: Read, Create, Edit, Grep, Glob
---
...
Load principles from `~/.factory/skills/domain-review/principles.md` for reference (P1-P13, T1-T12, Part 3). Load [vocabulary.md](vocabulary.md) for Nav's canonical terms.
